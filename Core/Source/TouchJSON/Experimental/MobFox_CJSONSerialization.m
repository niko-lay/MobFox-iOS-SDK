...
#import "MobFox_CJSONSerialization.h"

#import "MobFox_CJSONDeserializer.h"
#import "MobFox_CJSONSerializer.h"

@implementation MobFox_CJSONSerialization

+ (BOOL)isValidJSONObject:(id)obj
    {
    MobFox_CJSONSerializer *theSerializer = [MobFox_CJSONSerializer serializer];
...
+ (id)JSONObjectWithData:(NSData *)data options:(EJSONReadingOptions)opt error:(NSError **)error
    {
    MobFox_CJSONDeserializer *theDeserializer = [MobFox_CJSONDeserializer deserializer];
