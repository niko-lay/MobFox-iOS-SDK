...
@interface MPProgressOverlayViewMF ()
...
@implementation MPProgressOverlayViewMF
...
{
    self = [self initWithFrame:MPKeyWindowMF().bounds];
    if (self) {
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImage *image = [UIImage imageNamed:@"MobFoxMPCloseButtonX.png"];
