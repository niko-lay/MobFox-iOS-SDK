...
static NSString * const kCloseButtonXImageName = @"MobFoxMPCloseButtonX.png";

@interface MPInterstitialViewControllerMF ()
...
@implementation MPInterstitialViewControllerMF
...
- (void)presentInterstitialFromViewController:(UIViewController *)controller
{
    if (_isOnViewControllerStack) {
        MPLogWarnMF(@"Cannot present an interstitial that is already on-screen.");
        return;
    }
...
- (NSUInteger)supportedInterfaceOrientations
{
    ...
    [[UIApplication sharedApplication] supportedInterfaceOrientationsForWindow:MPKeyWindowMF()];
    ...
    if (!interstitialSupportedOrientations) {
        MPLogErrorMF(@"Your application does not support this interstitial's desired orientation "
...
- (UIInterfaceOrientation)preferredInterfaceOrientationForPresentation
{
    ...
    UIInterfaceOrientation currentInterfaceOrientation = MPInterfaceOrientationMF();
