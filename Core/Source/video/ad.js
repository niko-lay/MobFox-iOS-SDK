...
module.exports.parse = function(url,params,parent,cb){
    ...
    req.end(function(err,res){
        ...
        iframe.scrolling = "no";
        var html = "<style>\nbody{\nmargin:0;\npadding:0;\n}\niframe{border:none;}</style>"+json.request.htmlString.__cdata;
